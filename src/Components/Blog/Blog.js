        ...
        <div className="w-[95%] sm:w-[85%] m-auto">
          <div className="mt-[1rem] sm:mt-[3rem]">
            <p
              ...
              className="text-accent text-[1.9rem] md:text-[3.2rem] lg:text-[4.2rem] tracking-[1px] font-[700] text-left mb-[-10px] sm:mb-0"
            >
        ...
        <div className="w-[95%] sm:w-[85%] m-auto">
          <div className="flex flex-col gap-3 sm:gap-6 text-left">
            <h1
              data-aos="fade-up"
              data-aos-duration="1000"
              className="text-accent mt-0 sm:mt-5 font-semibold text-[18px] sm:text-3xl"
            >
            ...
            <p
              data-aos="fade-up"
              data-aos-duration="1000"
              className="text-primary leading-relaxed text-[12px] sm:text-[15px]"
            >
          ...
          <div className="mt-5 sm:mt-8 flex flex-col gap-6 pb-5 sm:pb-10 text-left">
            ...
            <span className="pl-5 text-lg leading-loose">
              <p
                data-aos="fade-up"
                data-aos-duration="1000"
                className="text-[13px] lg:text-[16px] text-primary"
              >
            ...
            <div className="bg-[#1d1d1d] px-6 sm:px-10 py-5 sm:py-8 border-l-4 border-[#4D66D0]">
              <p
                data-aos="fade-up"
                data-aos-duration="1000"
                className="text-[#767676] leading-relaxed text-[14px] md:text-[18px] font-bold italic"
              >
                Far far away, behind the word mountains, far from the countries
                Vokalia and Consonantia, there live the blind texts. Separated
            ...
            <span className="pl-5 text-lg leading-loose">
              <p
                data-aos="fade-up"
                data-aos-duration="1000"
                className="text-primary text-[13px] sm:text-[15px]"
              >
                1. Impenetrable foliage of my trees, and but a few stray gleams.
              </p>
              <p
